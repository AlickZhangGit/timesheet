export const queries = {
  ...
  getTimeByMonth:
    "SELECT * FROM timesheet.times WHERE email = $1 AND year = $2 AND month = $3;",
  insertTimes:
    "INSERT INTO timesheet.times (email, year, month, day, hours) VALUES $1 ON CONFLICT (email, year, month, day) DO UPDATE SET hours = excluded.hours;",
};
